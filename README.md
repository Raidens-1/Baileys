...
![WhatsApp API](https://files.catbox.moe/vkwszy.jpg)
...
```bash
npm install @Raidens-1/Baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @Raidens-1/Baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@Raidens-1/Baileys")
```
# Links
...
```javascript
const makeWASocket = require("@Raidens-1/Baileys").default;
const { useMultiFileAuthState } = require("@Raidens-1/Baileys");
...
```javascript
const makeWASocket = require("@Raidens-1/Baileys").default;
const { useMultiFileAuthState, makeCacheableSignalKeyStore } = require("@Raidens-1/Baileys");
...
```javascript
const makeWASocket = require("@Raidens-1/Baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@Raidens-1/Baileys");
...
```javascript
const makeWASocket = require("@Raidens-1/Baileys").default;
const { makeInMemoryStore } = require("@Raidens-1/Baileys");
...
const { downloadMediaMessage, getContentType } = require("@Raidens-1/Baileys");
